    ...
    <div>
      <el-form ref='loginFormRef' label-width="0px" :rules='loginFormRules' class="login_form" :model="loginForm" >
        ...
        <el-form-item prop="password">
          <el-input prefix-icon="el-icon-star-off" v-model="loginForm.password" type="password">
          </el-input>
        </el-form-item>
...
.login_form{position: absolute;bottom: 0;width: 100%;padding: 0 10px;box-sizing: border-box;}
